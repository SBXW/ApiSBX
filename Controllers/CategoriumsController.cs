...
namespace API_SBX.Controllers
{
    ...
    public class CategoriumsController : ControllerBase
    {
        ...
        public CategoriumsController(db_sbxContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Categorium>> PostCategorium(Categorium categorium)
        {
            ...
            return CreatedAtAction("GetCategorium", new { id = categorium.Codigo }, categorium);
        }
        ...
        {
            return _context.Categoria.Any(e => e.Codigo == id);
        }
    }
}

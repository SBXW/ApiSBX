...
namespace API_SBX.Controllers
{
    ...
    public class ProveedoresController : ControllerBase
    {
        ...
        public ProveedoresController(db_sbxContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Proveedor>> PostProveedor(Proveedor proveedor)
        {
            ...
            return CreatedAtAction("GetProveedor", new { id = proveedor.Dni }, proveedor);
        }
        ...
        {
            return _context.Proveedors.Any(e => e.Dni == id);
        }
    }
}
